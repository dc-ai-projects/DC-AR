...
# This file is modified from https://github.com/mit-han-lab/efficientvit and https://github.com/CompVis/taming-transformers
...
class VectorQuantizer(torch.nn.Module):
    ...
    def forward(self, z: torch.Tensor, **kwargs) -> Tuple[torch.Tensor, Mapping[Text, torch.Tensor]]:
        z = z.float()
